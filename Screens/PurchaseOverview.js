...
export default function Purchase({route}) {
    ...
    return (
      <View style={styles.main}>
        <Text style={styles.fontSize}>restaurant place holder</Text>
        <Text style={styles.fontSize}>table size place holder</Text>
        <Text style={styles.fontSize}>date place holder</Text>
        <Button style={styles.sellButton} onPress={() => navigation.navigate('Confirmation')}>
